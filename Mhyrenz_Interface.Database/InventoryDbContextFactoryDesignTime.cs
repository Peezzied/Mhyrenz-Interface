...
{
    public class InventoryDbContextFactoryDesignTime : IDesignTimeDbContextFactory<InventoryDbContext>
    {
        static InventoryDbContextFactoryDesignTime()
        {
        ...
        public InventoryDbContext CreateDbContext(string[] args = null)
        {
            ...
            options.UseSqlite("Data Source=dev_design_inventory.db");
