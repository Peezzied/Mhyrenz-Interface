...
namespace Mhyrenz_Interface.State
{
    public class TransactionStore : ITransactionStore
    {
        ...
        public TransactionStore(CreateViewModel<TransactionDataViewModel> transactionDataViewModel, ICheckoutService checkoutService)
        {
        ...
        public async void AddToSale(CheckoutResult result)
        {
            ...
            {
                var productId = checkoutResult.Transaction.ProductId;
